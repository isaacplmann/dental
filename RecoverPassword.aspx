<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" Inherits="OSUDental.RecoverPassword" %>
...
<div class="container">
    <form id="form1" runat="server" class="form-recover-password form-centered">
        <asp:PasswordRecovery ID="RecoverPass" runat="server" SubmitButtonStyle-CssClass="btn btn-large btn-primary" 
            MailDefinition-From="no-reply@smsosu.com"
            TitleTextStyle-CssClass="form-signin-heading" OnSendingMail="OnSendingMail" OnSendMailError="Unnamed_SendMailError" >
